...
public:
	...
	void setColorBy2DTexture( unsigned char* texturePtr,int width,int height);
	glm::vec3 getColorAtCoord( glm::vec4 texturecoord,unsigned char* texturePtr,int width,int height);
	glm::vec3 getColor();
	float* getVBO();
	float* getCBO();
	float* getNBO();
